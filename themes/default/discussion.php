<?php theme_include('partials/header'); ?>
	...
	<p>Posted in <a href="<?php echo category_url(); ?>"><?php echo category_title(); ?></a></p>
	<p>Started by <a href="<?php echo discussion_created_by_url(); ?>"><?php echo discussion_created_by(); ?></a></p>

	<p><strong><?php echo discussion_votes(); ?> Votes</strong> <a href="<?php echo discussion_vote_url(); ?>">Up Vote</a></p>

	<?php echo discussion_paging(); ?>
